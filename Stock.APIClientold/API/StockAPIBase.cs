...
namespace Stock.APILibrary.API
{
    public class StockAPIBase
    {
        ...
        protected async Task<T> InnerPostAsync<T>(string urlPostFix, string jsonIn) where T : class
        {
            T returnValue = null;
        ...
        protected async Task InnerPostAsync(string urlPostFix, string jsonIn)
        {
            HttpResponseMessage response = null;
        ...
        protected async Task InnerDeleteAsync(string urlPostFix)
        {
            HttpResponseMessage response = null;
        ...
        protected async Task InnerUpdateAsync(string urlPostFix, string jsonIn)
        {
            HttpResponseMessage response = null;
        ...
        protected async Task<T> InnerUpdateAsync<T>(string urlPostFix, string jsonIn) where T : class
        {
            HttpResponseMessage response = null;
            T returnValue = null;
