...
{
    public class StockHolderControllerIntegrationTests : IClassFixture<CustomWebApplicationFactory<Stock.API.Startup>>
    {
        #region Fields
        ...
        #region Constructor
        public StockHolderControllerIntegrationTests(CustomWebApplicationFactory<Stock.API.Startup> factory)
        {
            _Factory = factory;
        }
        #endregion
