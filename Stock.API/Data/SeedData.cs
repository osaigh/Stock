...
namespace Stock.API.Data
{
    public class SeedData
    {
        public static void InitializeDB(StockDbContext stockDbContext)
        {
            ...
            {
                var microsoft = new Models.Stock()
                {
                    Name = "Microsoft",
                    Price = 89,
                    Volume = 2000
                ...
                var slimStack = new Models.Stock()
                {
                    Name = "Slim Stack",
                    Price = 23,
                    Volume = 700
