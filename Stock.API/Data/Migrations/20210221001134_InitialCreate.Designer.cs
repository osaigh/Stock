...
namespace Stock.API.Data.Migrations
{
    ...
    [Migration("20210221001134_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Stock.Models.StockHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Stock.Models.StockHolder", b =>
                {
            ...
            modelBuilder.Entity("Stock.Models.StockHolderPosition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Stock.Models.StockPrice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Stock.Models.StockHistory", b =>
                {
                    b.HasOne("Stock.Models.Stock", null)
            ...
            modelBuilder.Entity("Stock.Models.StockHolderPosition", b =>
                {
                    b.HasOne("Stock.Models.StockHolder", "StockHolder")
